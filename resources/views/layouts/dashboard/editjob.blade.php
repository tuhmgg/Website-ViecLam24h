...
{{----}}
            ...
            <form action="{{route('job.update', [$listing->id])}}" method="POST" enctype="multipart/form-data">@csrf
                ...
                <div class="form-group">
                    ...
                    <div class="form-check">
                        <input type="radio" class="form-check-input" name="job_type" id="Remote" value="Từ Xa" {{$listing->job_type == 'Từ Xa' ? 'checked' : ''}}>
                        <label for="Remote" class="form-check-label">Từ Xa</label>
                    </div>
                    <div class="form-check">
                        <input type="radio" class="form-check-input" name="job_type" id="Contract" value="Hợp Đồng" {{$listing->job_type == 'Hợp Đồng' ? 'checked' : ''}}>
